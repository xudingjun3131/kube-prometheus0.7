...
(import '/root/kube-prometheus/jsonnet/kube-prometheus/github.com/brancz/kubernetes-grafana/grafana/grafana.libsonnet') +
(import './kube-state-metrics/kube-state-metrics.libsonnet') +
(import '/root/kube-prometheus/jsonnet/kube-prometheus/github.com/kubernetes/kube-state-metrics/jsonnet/kube-state-metrics-mixin/mixin.libsonnet') +
(import './node-exporter/node-exporter.libsonnet') +
(import '/root/kube-prometheus/jsonnet/kube-prometheus/github.com/prometheus/node_exporter/docs/node-mixin/mixin.libsonnet') +
(import './alertmanager/alertmanager.libsonnet') +
(import '/root/kube-prometheus/jsonnet/kube-prometheus/github.com/prometheus/alertmanager/doc/alertmanager-mixin/mixin.libsonnet') +
(import '/root/kube-prometheus/jsonnet/kube-prometheus/github.com/prometheus-operator/prometheus-operator/jsonnet/prometheus-operator/prometheus-operator.libsonnet') +
(import '/root/kube-prometheus/jsonnet/kube-prometheus/github.com/xudingjun3131/prometheus-operator1/jsonnet/jsonnet-mixin/mixin.libsonnet') +
(import './prometheus/prometheus.libsonnet') +
(import './prometheus-adapter/prometheus-adapter.libsonnet') +
(import '/root/kube-prometheus/jsonnet/kube-prometheus/github.com/kubernetes-monitoring/kubernetes-mixin/mixin.libsonnet') +
(import '/root/kube-prometheus/jsonnet/kube-prometheus/github.com/prometheus/prometheus/documentation/prometheus-mixin/mixin.libsonnet') +
